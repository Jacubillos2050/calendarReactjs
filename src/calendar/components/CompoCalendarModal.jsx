...
export const CompoCalendarModal = () => {

    const { isDateModalOpen, closeDateModal } = hooksUseUiStore();
    const { activeEvent, startSavingEvent } = hooksUseCalendarStore();
